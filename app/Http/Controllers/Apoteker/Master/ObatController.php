...
{
    private $views      = 'apoteker/master/obat';
    private $url      = 'apoteker/master-obat';
    ...
    {
        $this->obat->where('id', $id)->delete();
        return redirect("$this->url")->with('sukses', 'obat berhasil di hapus');
    }
