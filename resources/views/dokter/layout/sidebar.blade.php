    ...
    <ul class="nav">
      <li class="nav-item nav-profile">
        <a href="#" class="nav-link">
          ...
          <div class="nav-profile-text d-flex flex-column">
            <span class="font-weight-bold mb-2">dr.{{ session()->get('username') }}</span>
            <span class="text-secondary text-small">Dokter</span>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.html">
          <span class="menu-title"><a class="nav-link" href="{{ url('dokter/home') }}">Dashboard</span>
